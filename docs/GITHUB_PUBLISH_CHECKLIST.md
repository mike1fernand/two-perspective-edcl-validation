...
## No-H0 publish checks

Before publishing, verify that `release_assets/noh0_checkpointed_diagnostics_2026-05-04.zip`, `cosmology/docs/NOH0_CHECKPOINTED_DIAGNOSTICS.md`, `cosmology/scripts/noh0_checkpointed_diagnostics.py`, and the Colab notebook are present. Search for stale `q95=0.0497` claims and ensure the no-H0 q95 result is stated as not passed.
