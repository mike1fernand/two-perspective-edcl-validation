...
**Claim-discipline rule for Hubble results:** the current Tier-A1 cosmology result is a **mechanism-activation and collapse test**, not yet a completed Hubble-tension resolution. Stronger resolution language is reserved for the evidence ladder in `docs/HUBBLE_RESOLUTION_CLAIM_LADDER.md`.
